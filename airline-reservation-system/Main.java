public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < persons.length; i++) {
            ...
            if (persons[i].applyPassport()) {

                persons[i].setPassport();
                //airline.setPersons(persons[i], i);
                airline.createReservation(persons[i]);
            }
        }
        ...
        //THERE IS A toString method in the person class, So its prints the varibales!
        //System.out.println(persons[0]);

        //System.out.println(airline.getPerson(4));
